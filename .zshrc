...
PS1="%{$fg_bold[magenta]%}% :D%{$reset_color%}% %{$fg_bold[blue]%}%~%{$reset_color%}% %{$fg_bold[magenta]%}%%%{$reset_color%}%  "
...
##PS1='%{\e[1;35m%}:D%{\e[00m%}%{\e[1;34m%}%~%{\e[00m%}%{\e[1;35m%}$%{\e[00m%} '
#else
